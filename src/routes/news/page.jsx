...
const newsData = [
  {
    ...
    sous_titre: "Découvrez nos dernières mises à jour",
    description: "Nous avons ajouté de nouvelles fonctionnalités pour améliorer votre expérience.",
  ...
  },
  {
    ...
    sous_titre: "Interruption de service",
    description: "Une maintenance est prévue ce week-end. Veuillez planifier en conséquence.",
    imageCover: "https://placehold.co/150",
    enabled: false,
  },
  {
    ...
    sous_titre: "Ne manquez pas notre événement annuel",
    description: "Rejoignez-nous pour un événement passionnant avec des invités spéciaux.",
    imageCover: "https://placehold.co/150",
    enabled: true,
  },
  {
    ...
    sous_titre: "Profitez de réductions exclusives",
    description: "Des offres spéciales vous attendent. Ne manquez pas cette opportunité !",
    imageCover: "https://placehold.co/150",
    enabled: true,
  },
];
