...
// Données de démonstration pour les evenement
const eventsData = [
  {
    id: 1,
...
export default function EventsTable() {
  ...
  const handleDelete = () => {
    const updatedEvents = events.filter((item) => item.id !== selectedEvents.id);
    setEvents(updatedEvents);
    closeModals();
  };
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setSelectedEvents({ ...selectedEvents, titre: e.target.value })
              }
          ...
          <div>
            ...
            <textarea
              ...
              onChange={(e) =>
                setSelectedEvents({ ...selectedEvents, description: e.target.value })
              }
              className="w-full p-2 border border-gray-300 rounded-lg dark:bg-slate-700 dark:text-slate-50"
              rows="4"
              required
